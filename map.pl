...
room(throneRoom,'A great chamber surrounded by columns with a great and dirty carpet leading from the double doors to the stage. The throne itself is made of gold and occupied by a rotting corpse covered in blood.',[vampire],[],[exit(secretStairs, visible,unlocked),exit(win,hidden,locked)]).
